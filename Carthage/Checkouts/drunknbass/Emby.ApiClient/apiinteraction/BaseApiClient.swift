...
//    
    ...
    public init(logger: ILogger, jsonSerializer: IJsonSerializer, serverAddress: String, clientName: String,
    ...
    public init(logger: ILogger, jsonSerializer: IJsonSerializer, serverAddress: String, accessToken: String) {
        self.logger = logger
        self.jsonSerializer = jsonSerializer
        self.privateServerAddress = serverAddress
